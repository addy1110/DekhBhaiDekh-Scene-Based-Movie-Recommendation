(function () {
    ...
    angular
        .module('app')
        .controller('DramaController', DramaController);

    DramaController.$inject = ['UserService', '$rootScope', '$scope', '$location', '$q', '$http'];
    function DramaController(UserService, $rootScope, $scope, $location,  $q, $http) {
        var vm = this;
        // vm.imgShow = false;
        vm.dataloading=true;
        vm.myimg=[
